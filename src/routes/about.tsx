...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Nexora — Senior Engineering, Quietly Delivered" },
      {
        name: "description",
        content:
          "Nexora is a 220-person engineering firm building cloud, data and AI platforms for regulated enterprises since 2011.",
      },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        description="We are engineers first. Nexora exists because regulated industries deserve software teams that understand consequences."
      />
      <Section>
