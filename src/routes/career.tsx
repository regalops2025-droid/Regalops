...
export const Route = createFileRoute("/career")({
  head: () => ({
    meta: [
      { title: "Careers at Nexora — Senior Engineering Roles" },
      {
        name: "description",
        content:
          "Open engineering roles at Nexora: platform, data, cloud and security positions across Chennai, Bengaluru and remote.",
      },
