  ...
  head: () => ({
    meta: [
      ...
      { title: "Nexora — Enterprise Cloud, Data & AI Engineering" },
      {
        name: "description",
        content:
          "Nexora engineers cloud, data and AI platforms for regulated enterprises that cannot afford downtime.",
      },
      { name: "author", content: "Nexora Technologies" },
      { property: "og:title", content: "Nexora — Enterprise Cloud, Data & AI Engineering" },
      {
        property: "og:description",
        content: "Cloud, data and AI platforms engineered for uptime, scale and security.",
      },
